...
mypatientsdata <- cbind.data.frame(total_study$Sex, total_study$age, total_study$nonhdl, total_study$TotalC)
colnames(mypatientsdata) <- c("Sex", "age", "nonhdl", "totchol")
write.csv(mypatientsdata, "output/mypatientsdata.csv")
